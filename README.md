...
La version stable actuelle est `0.1.0`. La prochaine évolution en cours prépare la version `0.2.0` avec une mémoire de calculatrice permettant de mémoriser puis de restituer un nombre comme une saisie clavier.

Le projet est développé progressivement, avec validation par Pull Request et CI Windows. Le workflow de release valide désormais l'installation, l'analyse du code, les tests et la construction Windows avant toute mise à jour de version ou publication.
